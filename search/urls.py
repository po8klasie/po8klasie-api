...
router.register(r'publicinstitution', views.PublicInstitutionDataViewSet, basename='publicinstitutiondata')
router.register(r'privateinstitution', views.PrivateInstitutionDataViewSet, basename='privateinstitutiondata')
